...
public class AntPathMatcher {
    ...
    public AntPathMatcher(String pathSeparator) {
        Validate.notNull(pathSeparator, "'pathSeparator' must not be null");
    ...
    private String[] tokenizeToStringArray(String path, String pathSeparator, boolean trimTokens, boolean b) {
        String[] split = StringUtils.split(path, pathSeparator);
        if (trimTokens) {
